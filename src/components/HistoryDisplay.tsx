...
import type { AgentType, Message } from "../context/SessionStore";
import type { SummaryProps } from "./ChatSummaryDisplay";
    ...
    <div className="p-4 min-h-screen w-full flex flex-col gap-1">
      ...
      <div className=" text-gray-800 w-full md:max-w-[80%] m-auto flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {history.map((data) => (
            <SelectionTab text={data?.summary?.destination} Icon={FaHistory} />
          ))}
        </div>
      </div>
      <TailwindDevTool />
